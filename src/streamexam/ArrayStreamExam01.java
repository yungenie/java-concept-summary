...
/**
 * Stream 만들기 - 객체 배열 및 기본형 배열로부터 Stream 생성하기
 * <p><blockquote><pre>
...
public class ArrayStreamExam01 {
    public static void main(String[] args) {
        ...
        Stream<String> streamStrArgs = Stream.of("1", "2"); // 가변인자 // Stream.of(T) T는 Stream<T> 타입변수
        ...
        IntStream intStream = IntStream.of(intArr); // IntStream.of(v) v(인자)는 int 타입
